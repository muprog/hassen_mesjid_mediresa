...
export default function DirectorCreateStudentPage() {
  ...
  return (
    <div>
      <div className='mb-6'>
        ...
        <p className='text-gray-600 mt-1'>Add a new student</p>
      </div>
      ...
      >
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          ...
          <div>
            <label className='block text-sm font-medium text-gray-700'>
              Haleqa <span className='text-red-500'>*</span>
            </label>
            <input
              type='text'
              required
          ...
          <div className='md:col-span-2'>
            ...
            <textarea
              ...
              className='mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md'
              placeholder='e.g. Juz 5, memorizing Surah Al-Kahf'
            />
          </div>
